...
# ============================================================
# CORS CONFIG (LOCAL + VERCEL + RAILWAY SAFE)
# ============================================================
# Set this in Railway Variables, example:
# CORS_ORIGINS=http://localhost:3000,http://127.0.0.1:3000,https://virtualward-frontend.vercel.app
origins = os.getenv(
    "CORS_ORIGINS",
    "http://localhost:3000,http://127.0.0.1:3000,https://virtualward-frontend.vercel.app",
).split(",")
...
# ------------------------------------------------------------
# OPTIONAL: If you want to allow ALL Vercel preview deployments
# (e.g. https://virtualward-frontend-xyz.vercel.app)
# then comment out the allow_origins middleware above and use:
#
# app.add_middleware(
#     CORSMiddleware,
